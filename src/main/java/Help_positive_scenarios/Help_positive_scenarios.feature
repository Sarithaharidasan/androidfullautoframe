Feature: Test help positive functionality
  ...
  Scenario: Validate that the My Medicare title  should be present  and able to see description , when user click on My Medicare title
    Then check able to see description , when user click on My Medicare title

  Scenario: Validate that the Apple Health  title  should be present  and able to see description , when user click on Apple Health title
    Then check able to see description , when user click on Apple Health  title
